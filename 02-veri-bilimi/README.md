...
| `e_ticaret_ara_analiz.ipynb` | Notebook | Veri seti tanıma, eksik/aykırı değer temizleme, metin standartlaştırma, tip dönüşümleri ve temel EDA adımları |
...
### 📄 1. Ara Ödev (`e_ticaret_ara_analiz.ipynb`)
...
### 📄 2. Final Ödevi (`e_ticaret_kesifsel_veri_analizi.ipynb`)
